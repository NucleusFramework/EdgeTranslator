...
Prebuilt packages (DMG, NSIS, Deb) are published on [GitHub Releases](https://github.com/NucleusFramework/EdgeTranslator/releases). Packaged builds update themselves from there.
