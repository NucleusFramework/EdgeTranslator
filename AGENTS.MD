...
| **Compose stability dump** | `./gradlew :sharedUI:compileKotlinJvm :sharedUI:stabilityDump` |
| **Compose stability check** | `./gradlew :sharedUI:compileKotlinJvm :sharedUI:stabilityCheck` |
